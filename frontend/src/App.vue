...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapActions(['socketConnectGeneral', 'combat_legendSetGameData', 'modalsSetShow', 'socketConnectCombat_legend'])
        },
        computed: {
            ...mapGetters(['socketGeneral', 'generalSettings', 'authToken', 'authUser', 'combat_legendGames']),
            appGetRouteName() {
                    ...
                    if(this.authUser.user !== null){
                        for(const game of this.combat_legendGames){
                            for(const bet of game.bets){
                                if(bet.user._id == this.authUser.user._id && game.state == "countdown"){
                                    this.combat_legendSetGameData(game);
