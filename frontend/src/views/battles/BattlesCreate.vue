...
<style scoped>
    ...
    .battles-create .create-select {
        ...
        background: linear-gradient(0deg, rgba(0, 0, 0, 0.3) 0%, rgba(0, 0, 0, 0.3) 100%), 
                    linear-gradient(223deg, rgb(66, 107, 252, 0.2) 0%, rgba(31, 99, 153, 0.05) 50%, rgb(66, 107, 252, 0.2) 100%);
    ...
    .battles-create .create-select button.button-add .button-inner {
        ...
        justify-content: center;
        align-items: center;
        background: linear-gradient(223deg, rgb(66, 107, 252, 0.2) 0%, rgba(31, 99, 153, 0.1) 100%, rgb(66, 107, 252, 0.2) 100%);
        border: 1px solid #5f1c1c;
    }
