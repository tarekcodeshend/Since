...
<style scoped>
    ...
    .roll-card.card-low::before {
        background: linear-gradient(180deg, rgba(255, 0, 0, 0.5) 0%, rgba(255, 0, 0, 0.25) 50%, #f00 100%);
    }
    ...
    .roll-card.card-low .card-inner {
        background: radial-gradient(230% 105% at 50% 15%, rgba(0, 0, 0, 0.35) 0%, rgba(0, 0, 0, 0.46) 30%, rgba(0, 0, 0, 0.42) 65%, rgba(0, 0, 0, 0) 100%), linear-gradient(0deg, rgba(255, 0, 0, 0.75) -30%, rgba(255, 0, 0, 0.75) -16%, rgba(255, 0, 0, 0.26) 30%, rgba(0, 0, 0, 0) 100%), #062137;
