<template>
    <a class="banner-mode" href="https://discord.gg/bloxflamecom" target="_blank">
        <div class="mode-text">
...
<style scoped>
    .banner-mode {
        ...
        font-family: 'Rubik';
        background: linear-gradient(255deg, #6a1a1a911 -7%, rgba(0, 0, 0, 0) 55%), radial-gradient(90% 90% at 50% 28%, #0f7979 0%, #021729 100%);
    }
