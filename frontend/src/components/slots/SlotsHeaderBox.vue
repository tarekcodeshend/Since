<template>
    <div class="slots-header-box">
        <router-link class="link-back" to="/slots">
        ...
        <div v-if="slotsBoxData.box !== null" class="box-mid">
            <div class="mid-info">
                <div class="info-inner">
                    <div class="inner-image">
                        <div class="image-inner">
                            <img v-bind:src="slotsImagePath + '/public/img/slots/' + slotsBoxData.box.Id + '.jpeg'" />
                        </div>
                    </div>
                    {{slotsBoxData.box.Name}}
                </div>
            </div>
        </div>
        <!-- <button v-on:click="slotsFairButton()" class="button-fair">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                slotsImagePath: process.env.VUE_APP_BACKEND_URL
            }
        },
        methods: {
            ...mapActions([
...
<style scoped>
    ...
    .slots-header-box a.link-back::before {
        content: '';
        width: 100%;
        height: 100%;
        position: absolute;
    ...
    .slots-header-box a.link-back .link-inner {
        width: 100%;
        height: 100%;
        display: flex;
    ...
    .slots-header-box a.link-back:hover .link-inner {
        color: #ffffff;
    }

    .slots-header-box a.link-back .link-inner svg {
        margin-right: 8px;
        fill: #557b9b;
        transition: fill 0.3s ease;
    }

    .slots-header-box a.link-back:hover .link-inner svg {
        fill: #ffffff;
    }

    .slots-header-box .box-mid {
        width: calc(100% - 223px);
        padding-left: 20px;
    }

    .slots-header-box .mid-info {
        width: 243px;
        height: 62px;
        position: relative;
        padding: 1px;
    ...
    .slots-header-box .mid-info::before {
        content: '';
        width: 100%;
        height: 100%;
        position: absolute;
    ...
    .slots-header-box .image-inner img {
        height: 52px;
    }

    .slots-header-box button.button-fair {
        width: 113px;
        height: 32px;
        filter: drop-shadow(0px 2px 2px rgba(0, 0, 0, 0.10));
    }

    .slots-header-box button.button-fair .button-inner {
        width: 100%;
        height: 100%;
        display: flex;
        justify-content: center;
    ...
    .slots-header-box button.button-fair:hover .button-inner {
        color: #ffffff;
    }

    .slots-header-box button.button-fair .button-inner svg {
        margin-right: 6px;
        fill: #bbbfd0;
        transition: fill 0.3s ease;
    }

    .slots-header-box button.button-fair:hover .button-inner svg {
        fill: #ffffff;
    }
