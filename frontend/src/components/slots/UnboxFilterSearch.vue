<template>
    <div class="slots-filter-search">
        <input v-on:input="slotsSetFilterSearch(slotsSearch)" v-model="slotsSearch" type="text" placeholder="SEARCH FOR GAMES..." />
...
<script>
    ...
    export default {
        ...
        created() {
            this.slotsSearch = this.slotsFilterSearch;
        }
    }
</script>
...
<style scoped>
    ...
    .slots-filter-search input {
        ...
        font-weight: 600;
        color: #ffffff;
        background: linear-gradient(223deg, rgb(66, 107, 252, 0.2) 0%, rgba(31, 99, 153, 0.05) 50%, rgb(66, 107, 252, 0.2) 100%);
        clip-path: polygon(9px 0, calc(100% - 9px) 0, 100% 25%, 100% 75%, calc(100% - 9px) 100%, 9px 100%, 0 75%, 0 25%);
    }

    .slots-filter-search input::placeholder {
        color: #395b77;
    }
