...
<style scoped>
    ...
    .affiliates-stats .stats-element.element-available .element-inner {
        background: linear-gradient(256deg, rgba(255, 0, 0, 0.05) 0%, rgba(0, 170, 109, 0.05) 100%), radial-gradient(81.75% 81.75% at 50% 50%, rgba(255, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0) 100%);
    }
