        ...
        <div class="code-inner">
            <div class="inner-info">
                <div class="info-text">
                    ...
                    <div class="text-link">
                        https://bloxflame.com/?a={{ affiliatesData.data !== null && affiliatesData.data.code !== undefined ? affiliatesData.data.code : '' }}                    <button v-if="affiliatesData.data !== null && affiliatesData.data.code !== undefined" v-on:click="affiliatesCopyButton" class="button-copy">
                            <IconCopy />
                        </button>
                    </div>
                </div>
    ...
    export default {
       ...
       methods: {
            ...
            affiliatesCopyButton() {
                ...
                el.value = 'https://bloxflame.top/?a=' + (this.affiliatesData.data !== null && this.affiliatesData.data.code !== undefined ? this.affiliatesData.data.code : '');
