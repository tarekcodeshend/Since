...
<style scoped>
    ...
    .rain-join .join-inner {
        ...
        border-radius: 15px;
        background: radial-gradient(225% 225% at 50% -10%, rgb(182 1 1 / 43%) 0%, rgba(0, 0, 0, 0) 100%), 
                    linear-gradient(255deg, rgba(255, 0, 0, 0.05) 0%, rgba(0, 170, 109, 0.05) 90%), rgba(0, 0, 0, 0.34);
    }
    ...
    .rain-join button.button-claim .button-inner {
        ...
        justify-content: center;
        align-items: center;    
        background: linear-gradient(255deg, #f00 20%, #f00 70%);
        clip-path: polygon(3px 0, calc(100% - 3px) 0, 100% 25%, 100% 75%, calc(100% - 3px) 100%, 3px 100%, 0 75%, 0 25%);
    }

    .rain-join button.button-claim:disabled .button-inner {
        background: linear-gradient(265deg, rgba(255, 0, 0, 0.25) 20%, rgba(0, 170, 109, 0.25) 70%);
    }
    ...
    .rain-join button.button-claim:disabled .button-inner span {
        background: linear-gradient(256.23deg, #f00 0%, #f00 100%);
