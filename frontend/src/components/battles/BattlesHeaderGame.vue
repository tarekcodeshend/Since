    ...
    export default {
        ...
        computed: {
            ...
            battlesGetLink() {
                ...
                if(this.battlesGameData.game !== null) { link = 'BLOXFlame.com/battles/' + this.battlesGameData.game._id; }
...
<style scoped>
    ...
    .battles-header-game button.button-sound {
        ...
        align-items: center;
        border-radius: 5px;
        background: radial-gradient(70% 70% at 50% 50.00%, rgba(152, 151, 193, 0.2) 0%, rgba(0, 0, 0, 0) 100%), #2e0303;
