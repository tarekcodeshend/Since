...
<style scoped>
    .battles-box-element {
        ...
        background: linear-gradient(0deg, rgba(255, 255, 255, 0.01) 0%, rgba(255, 255, 255, 0.01) 100%), 
                    linear-gradient(223deg, rgb(66, 107, 252, 0.2) 0%, rgba(31, 99, 153, 0.09) 50%, rgb(66, 107, 252, 0.2) 100%);
    ...
    .modal-battles-select .battles-box-element {
        ...
        background: linear-gradient(0deg, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.2) 100%), 
                    ...
                    linear-gradient(223deg, rgb(66, 107, 252, 0.2) 0%, rgba(31, 99, 153, 0.1) 50%, rgb(66, 107, 252, 0.2) 100%);
    }

    .modal-battles-select .battles-box-element.element-selected {
        background: linear-gradient(223deg, rgb(66, 107, 252, 0.2) 0%, rgba(31, 99, 153, 0.1) 50%, rgb(66, 107, 252, 0.2) 100%);
    ...
    .battles-box-element .element-count button.button-increase {
        ...
        justify-content: center;
        align-items: center;
        background: linear-gradient(223deg, rgb(66, 107, 252, 0.2) 0%, rgba(31, 99, 153, 0.12) 50%, rgb(66, 107, 252, 0.2) 100%);
        border: 1px solid #5f1c1c;
    }
