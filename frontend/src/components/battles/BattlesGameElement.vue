...
<style scoped>
    ...
    .battles-game-element .element-inner {
        ...
        align-items: center;
        background: linear-gradient(223deg, rgb(66, 107, 252, 0.2) 0%, rgba(31, 99, 153, 0.03) 50%, rgb(66, 107, 252, 0.2) 100%), #000000;
    }
    ...
    .battles-game-element .type-inner {
        ...
        background: radial-gradient(80% 80% at 50% 50%, rgba(46, 62, 202, 0.20) 0%, rgba(0, 0, 0, 0) 100%), 
                    linear-gradient(223deg, rgb(66, 107, 252, 0.2) 0%, rgba(31, 99, 153, 0) 100%),
    ...
    .battles-game-element.element-group .type-inner {
        background: linear-gradient(223deg, rgba(255, 0, 0, 0.25) 0%, rgba(0, 170, 109, 0.25) 100%), 
                    linear-gradient(223deg, rgb(66, 107, 252, 0.2) 0%, rgba(31, 99, 153, 0) 100%),
                    repeating-linear-gradient(-55deg, rgba(255, 255, 255, 0.03), rgba(255, 255, 255, 0.03) 5px, rgba(2, 21, 36, 0.25) 5px, rgba(2, 21, 36, 0.25) 10px);
    }
    ...
    .battles-game-element .element-separator::before {
        ...
        top: 0;
        left: 0;
        background: linear-gradient(180deg, rgba(6, 36, 61, 0) 0%, #f00 100%);
    ...
    .battles-game-element button.button-join:before {
        ...
        top: 0;
        left: 0;
        background: linear-gradient(180deg, rgba(0, 170, 109, 0) 0%, #f00 100%);
        clip-path: polygon(6px 0, calc(100% - 6px) 0, 100% 25%, 100% 75%, calc(100% - 6px) 100%, 6px 100%, 0 75%, 0 25%);
    }

    .battles-game-element button.button-waiting:before {
        background: linear-gradient(180deg, rgba(0, 170, 109, 0) 0%, rgba(255, 0, 0, 0.2) 100%);
    }
    ...
    .battles-game-element .funding-inner {
        ...
        justify-content: center;
        align-items: center;
        background: linear-gradient(242deg, rgba(255, 0, 0, 0.4) 16%, rgba(0, 231, 170, 0.22) 32%, rgba(0, 218, 157, 0.1) 50%, rgba(0, 195, 134, 0.26) 80%, rgba(0, 170, 109, 0.44) 100%), 
    ...
    .battles-game-element .funding-inner span {
        font-size: 11px;
        font-weight: 800;
        background: linear-gradient(239deg, #f00 -100%, #f00 120%);
        background-clip: text;
        -webkit-background-clip: text;
        -webkit-text-fill-color: transparent;
    }
    ...
    .battles-game-element button.button-waiting .button-inner {
        background: linear-gradient(255deg, rgba(255, 0, 0, 0.15) 0%, rgba(0, 170, 109, 0.15) 100%), #051f35;
    }
