...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            battlesGetBotName() {
                let name = 'Crazy Site Dev';

                if(this.pos === 2) { name = 'Crazy Site Dev Jr.'; }
                else if(this.pos === 3) { name = ' Crazy Site Dev Sr.'; }
...
<style scoped>
    ...
    .battles-bet-element.element-winner .element-top {
        background: linear-gradient(270deg, rgba(1, 229, 168, 0.7) 0%, rgba(0, 0, 0, 0) 45%), #5f1c1c;
    }

    .battles-bet-element.element-lost .element-top {
        background: linear-gradient(270deg, rgba(245, 80, 70, 0.7) 0%, rgba(0, 0, 0, 0) 45%), #5f1c1c;
    }

    .battles-bet-element .top-inner {
        width: 100%;
        height: 100%;
        background: linear-gradient(223deg, rgb(66, 107, 252, 0.2) 0%, rgba(31, 99, 153, 0.1) 50%, rgb(66, 107, 252, 0.2) 100%), #041f35;
    }

    .battles-bet-element.element-winner .top-inner {
        background: linear-gradient(223deg, rgba(1, 232, 171, 0.2) 0%, rgba(0, 0, 0, 0) 50%), 
                    linear-gradient(223deg, rgb(66, 107, 252, 0.2) 0%, rgba(31, 99, 153, 0.1) 50%, rgb(66, 107, 252, 0.2) 100%), #041f35;
    }
    ...
    .battles-bet-element .funding-inner {
        ...
        justify-content: center;
        align-items: center;
        background: linear-gradient(242deg, rgba(255, 0, 0, 0.44) 16%, rgba(0, 231, 170, 0.22) 32%, rgba(0, 218, 157, 0.1) 50%, rgba(0, 195, 134, 0.26) 80%, rgba(0, 170, 109, 0.44) 100%), 
