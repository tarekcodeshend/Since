...
<style scoped>
    ...
    .towers-controls .controls-mode button.button-active .button-inner {
        color: #00fff2;
        background: radial-gradient(81.75% 81.75% at 50% 50%, rgba(255, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0) 100%), linear-gradient(256.23deg, rgba(255, 0, 0, 0.05) 0%, rgba(0, 170, 109, 0.05) 100%);
    }
    ...
    .towers-controls button.button-cashout .button-inner {
        background: linear-gradient(255deg, rgba(255, 0, 0, 0.35) -20%, rgba(0, 170, 109, 0.35) 100%);
    }
