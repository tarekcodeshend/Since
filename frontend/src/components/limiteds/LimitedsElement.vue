...
<style scoped>
    ...
    button.limiteds-element.element-active::before {
        background: linear-gradient(180deg, rgba(255, 0, 0, 0), #f00 100%);
        border: none;
    }
    ...
    button.limiteds-element .element-inner {
        ...
        padding: 20px 10px;
        border-radius: 20px;
        background: linear-gradient(255deg, rgba(255, 0, 0, 0.02) 0%, rgba(0, 170, 109, 0.02) 100%), radial-gradient(80% 80% at 50% 50%, rgba(255, 0, 0, 0.05) 0%, rgba(0, 0, 0, 0) 100%);
    ...
    button.limiteds-element.element-active .element-inner {
        background: linear-gradient(255deg, rgba(255, 0, 0, 0.02) 0%, rgba(0, 170, 109, 0.02) 100%), radial-gradient(80% 80% at 50% 50%, rgba(255, 0, 0, 0.35) 0%, rgba(0, 0, 0, 0) 100%);
    }
