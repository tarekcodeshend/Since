    ...
    <div class="admin-filter-amount" v-bind:class="{ 'amount-open': adminDropdown === true }">
        ...
        <div class="amount-menu">
            <div class="menu-inner">
                <button v-on:click="adminSetButton('1.5')">R$500 Gift Card</button>
                <button v-on:click="adminSetButton('3')">R$1000 Gift Card</button>
                <button v-on:click="adminSetButton('9')">R$3000 Gift Card</button>
                <button v-on:click="adminSetButton('30')">R$10000 Gift Card</button>
                <button v-on:click="adminSetButton('75')">R$25000 Gift Card</button>
