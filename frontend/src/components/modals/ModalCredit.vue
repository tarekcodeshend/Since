<template>
    <div class="modal-credit">
        ...
        <div class="credit-info">
            Card payments are processed through a secure third-party processor. BLOXFlame does not store or process your card details.
        </div>
    </div>
</template>
...
<style scoped>
    ...
    .modal-credit .amount-buttons button .button-inner {
        ...
        font-weight: 800;
        color: #ffffff;
        background: linear-gradient(225deg, rgba(255, 0, 0, 0.01) 0%, rgba(0, 170, 109, 0.01) 100%), #10253c;
        box-shadow: 0px 5px 50px 0px rgba(0, 0, 0, 0.25) inset;
    }

    .modal-credit .amount-buttons button.button-active .button-inner {
        background: linear-gradient(225deg, rgba(255, 0, 0, 0.01) 0%, rgba(0, 170, 109, 0.01) 100%), 
                    radial-gradient(80% 80% at 50% 50%, rgba(255, 0, 0, 0.35) 0%, rgba(0, 0, 0, 0) 100%), #10253c;
    } 
