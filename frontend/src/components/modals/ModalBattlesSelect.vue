...
<style scoped>
    .modal-battles-select {
        ...
        background: linear-gradient(0deg, rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.1) 100%), 
                    linear-gradient(223deg, rgb(66, 107, 252, 0.2) 0%, rgba(31, 99, 153, 0) 100%), #042238;
    ...
    .modal-battles-select .select-header:after {
        ...
        background: linear-gradient(146deg, rgb(255 255 255) 0%, rgba(28, 71, 182, 0.15) 100%);
    }
    ...
    .modal-battles-select .select-footer {
        ...
        background: linear-gradient(0deg, #0b2b44 0%, #0b2b44 100%), 
                    linear-gradient(223deg, rgb(66, 107, 252, 0.2) 0%, rgba(31, 99, 153, 0.00) 100%), #042238;
    }
