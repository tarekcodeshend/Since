    ...
    <div class="modal-login">
        ...
        <div class="login-content">
            ...
            <div v-if="['login', 'register', 'roblox login', 'roblox cookie'].includes(modalTab) === true" class="content-auth">
                ...
                <button v-else v-on:click="modalSetTab('roblox cookie')" class="button-roblox">
...
<style scoped>
    .modal-login {
        width: 1010px;
        border-radius: 15px;
        background: radial-gradient(100% 100% at 50% -31.45%, rgba(255, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0) 100%), linear-gradient(255deg, #07263d 0%, #07243a 100%);
    }
    ...
    .modal-login .login-sidebar {
        ...
        background: radial-gradient(225% 75% at 50% 50%, rgba(21, 71, 98, 0.2) 0%, rgba(0, 0, 0, 0) 100%), #1b1b1b;
    }
    ...
    .modal-login .sidebar-text {
        ...
        padding: 15px 30px;
        text-align: center;
        background: linear-gradient(255deg, rgba(255, 0, 0, 0.05) 0%, rgba(0, 170, 109, 0.05) 100%);
    }
    ...
    .modal-login .sidebar-text::before {
        ...
        top: 0;
        left: 0;
        background: linear-gradient(255deg, rgba(255, 0, 0, 0.5) 0%, rgba(0, 170, 109, 0.5) 100%), #18486d;
    }
