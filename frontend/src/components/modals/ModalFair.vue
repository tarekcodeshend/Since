...
<style scoped>
    .modal-fair {
        ...
        border-radius: 15px;
        background: radial-gradient(100% 100% at 50% 0%, rgba(255, 0, 0, 0.2) 0%, rgba(7, 38, 61, 0) 80%), 
    ...
    .modal-fair .header-icon {
        ...
        align-items: center;
        border-radius: 50%;
        background: linear-gradient(255deg, rgba(255, 0, 0, 0.2)0%, rgba(0, 170, 109, 0.2) 100%);
    }
    ...
    .modal-fair .fair-nav button.button-active .button-inner {
        background: radial-gradient(50% 50% at 50% 50%, rgba(255, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0) 100%), 
