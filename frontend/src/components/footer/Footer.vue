    ...
    <footer id="footer">
        <div class="footer-top">
            <div class="top-info">
                ...
                <div class="info-text">
                    BLOXFlame.com is the #1 Roblox Gambling Website and offers the best experience & reward to our users.
            ...
            <div class="top-links">
                ...
                <div class="links-section">
                    ...
                    <a href="https://discord.com/invite/bloxflamecom" target="_blank">Support</a>
                    <button v-on:click="modalsSetShow('Fair')">Provably Fair</button>
                </div>
                <div class="links-section">
                    <div class="section-title">SOCIALS</div>
                    <a href="https://x.com/BloxF67062" target="_blank">
                    ...
                    <a href="https://discord.com/invite/bloxflamecom" target="_blank">
                        <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="footer-bottom">
            <span class="gradient-green">BLOXFlame is not affiliated, associated or partnered with the Roblox corporation in any way. We are not authorized, endorsed or sponsored by the Roblox Corporation. All Roblox trademarks remain property of the Roblox Corporation.</span>
        </div>
    </footer>
</template>
...
<style>
    ...
    footer#footer .top-info::after {
        ...
        top: 0;
        right: 0;
        background: linear-gradient(0deg, transparent 50%, #1b1b1b 50%), linear-gradient(0deg, rgba(0, 17, 31, 0) 0%, rgba(39, 255, 177, 0.5) 50%, rgba(0, 17, 31, 0) 100%);
    ...
    footer#footer .section-title::after {
        ...
        top: 0;
        right: 0;
        background: linear-gradient(0deg, transparent 50%, #1b1b1b 50%), linear-gradient(0deg, rgba(0, 17, 31, 0) 0%, rgba(39, 158, 255, 0.5) 50%, rgba(0, 17, 31, 0) 100%);
        background-size: 1px 2px, 2px 100%;
    }
