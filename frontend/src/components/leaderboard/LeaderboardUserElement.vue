...
<style scoped>
    ...
    .leaderboard-user-element:nth-child(1) .element-inner {
        background: radial-gradient(163.2% 163.2% at 50% -31.45%, rgba(255, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0) 100%), linear-gradient(255deg, rgba(255, 0, 0, 0.15) 0%, rgba(0, 170, 109, 0.15) 100%);
    }
