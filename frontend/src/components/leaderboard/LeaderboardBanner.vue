...
<style scoped>
    ...
    .leaderboard-banner::after {
        ...
        left: 1px;
        border-radius: 25px;
        background: radial-gradient(35% 255% at 95% 0%, rgba(0, 255, 209, 0.2) 0%, rgba(0, 0, 0, 0) 100%), radial-gradient(100% 770% at 18% 57%, rgba(0, 36, 130, 0.2) 0%, rgba(0, 0, 0, 0) 100%), radial-gradient(100% 70% at 100% 0%, #6a1a1a 0%, #0f0f0f 100%);
    ...
    .leaderboard-banner .ranks-step {
        ...
        filter: drop-shadow(0px 4px 25px rgba(255, 0, 0, 0.47));
