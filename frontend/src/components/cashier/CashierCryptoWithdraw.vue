...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            cashierCoinInput() {
                this.cashierFiatAmount = parseFloat((this.cashierCoinAmount / 1000) * 1.9).toFixed(2);
            ...
            cashierCryptoInput() {
                ...
                this.cashierCoinAmount = parseFloat((this.cashierFiatAmount / 1.9) * 1000).toFixed(2);
            },
            cashierFiatInput() {
                this.cashierCoinAmount = parseFloat((this.cashierFiatAmount / 1.9) * 1000).toFixed(2);;
                this.cashierCryptoAmount = parseFloat(1 / (this.cashierCryptoData.prices[this.modalsData.currency].price / 1000) * this.cashierFiatAmount).toFixed(8)
        ...
        watch: {
            'cashierCryptoData.prices': {
                handler() {
                    this.cashierCoinAmount = parseFloat((100 / 1.9) * 1000).toFixed(2);
