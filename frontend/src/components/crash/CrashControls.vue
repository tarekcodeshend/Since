...
<style scoped>
    ...
    .crash-controls .controls-mode button.button-active .button-inner {
        background: radial-gradient(135.81% 81.75% at 83.06% 50%, rgba(255, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0) 100%), linear-gradient(255deg, rgba(255, 0, 0, 0.05) -46.99%, rgba(0, 170, 109, 0.05) 100%);
    }
