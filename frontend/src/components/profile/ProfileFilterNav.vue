    ...
    <div class="profile-filter-nav" v-bind:class="{ 'nav-open': profileDropdown === true }">
        ...
        <div class="nav-menu">
            <div class="menu-inner">
                <router-link to="/profile" v-on:click.native="profileToggleDropdown()">Settings</router-link>
                <router-link to="/profile/transactions" v-on:click.native="profileToggleDropdown()">Transactions</router-link>
