const state = {
    ...
    soundCombat_legend: localStorage.getItem('soundDuels') === null ? 1 : Number(localStorage.getItem('soundDuels')),
...
const getters = {
    ...
    soundCombat_legend: state => state.soundCombat_legend,
...
const mutations = {
    ...
    sound_set_combat_legend(state, value) {
        state.soundCombat_legend = value;
    },
...
const actions = {
    ...
    soundSetCombat_legend({ commit }, value) {
        commit('sound_set_combat_legend', value);
        localStorage.setItem('soundCombat_legend', value);
    },
